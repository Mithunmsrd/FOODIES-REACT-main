  ...
  return (
    ...
    <div class="bg-slate-300 p-8 rounded shadow-lg max-w-md w-full">
        ...
        <form action="#" method="POST">
            ...
            <a href="/AddHotel" type="submit" class="w-full bg-indigo-500 text-white px-4 py-2 rounded-md hover:bg-indigo-600  focus:bg-indigo-600 ml-[150px]">Login</a>
        </form>
        <p class="mt-4 text-sm text-center text-gray-600">Don't have an account? <a href="/AdminRegister" class="text-indigo-500 hover:underline">Register here</a></p>
    </div>
</div>
    </div>
  )
